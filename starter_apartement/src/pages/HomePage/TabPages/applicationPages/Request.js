...
import { acceptApartmentRequest, rejectApartmentRequest } from "../../../../services/managerService";
  ...
  <div class="bg-white rounded-lg shadow-lg px-6 py-8">
    ...
    <div class="flex flex-col space-y-4">
      <div class="flex flex-col sm:flex-row justify-between">
        ...
        <span class="text-gray-700">{data.user.name+" "+ data.user.fatherName+' '+data.user.grandFatherName}</span>
      </div>
      <div class="flex flex-col sm:flex-row justify-between">
      ...
      {isPending && (
        ...
        <input class="text-gray-700" type="date" value={startDate} onChange={(e)=>setStartDate(e.target.value)}/>
      </div>
      <div class="flex flex-col sm:flex-row justify-between mt-6">
